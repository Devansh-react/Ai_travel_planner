...
import type { QualificationDecisionInput } from "../src/types/llm";

function baseInput(): QualificationDecisionInput {
  return {
...
describe("qualificationService", () => {
  test("asks for contact once the qualifying threshold is reached", () => {
    ...
    const decision = qualificationService.decide(input);
